...
declare global {
    namespace ig {
        namespace EFFECT_ENTRY {
            ...
            let COPY_SPRITE_SPECIAL_COLOR_EL: COPY_SPRITE_SPECIAL_COLOR_EL_CONSTRUCTOR;
            ...
            let SET_MODE_AURA_HIDE: SET_MODE_AURA_HIDE_CONSTRUCTOR;
        }
        ...
        namespace ACTION_STEP {
            ...
            let EL_SET_TARGET_POS: EL_SET_TARGET_POS_CONSTRUCTOR;
            ...
            let EL_SET_PARTY_TEMP_TARGET_BY_INDEX: EL_SET_PARTY_TEMP_TARGET_BY_INDEX_CONSTRUCTOR
            ...
            let ADD_ARENA_SCORE: ADD_ARENA_SCORE_CONSTRUCTOR;

            namespace SET_ENEMY_LEVEL {
                interface Settings {
                    level: ig.Event.NumberExpression;
                }
            }
            ...
            let SET_ENEMY_LEVEL: SET_ENEMY_LEVEL_CONSTRUCTOR;
        ...
        namespace EVENT_STEP {
            ...
            let OPEN_GEODE_MENU: OPEN_GEODE_MENU_CONSTRUCTOR;
        }
    }
}